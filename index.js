#!/usr/bin/env node
/**
 * Fetch coduri reducere Eden Boutique de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/edenboutique.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/edenboutique.ro";
const STORE_NAME  = "Eden Boutique";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-eden-boutique)" }
  });
