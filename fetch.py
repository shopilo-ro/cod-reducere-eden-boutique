#!/usr/bin/env python3
"""
Fetch coduri de reducere Eden Boutique de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/edenboutique.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/edenboutique.ro"
STORE_NAME = "Eden Boutique"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Eden Boutique de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-eden-boutique)"
    }
    try:
